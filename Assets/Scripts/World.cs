...
public class World : MonoBehaviour
{
    ...
    public BlockType GetBlockFromWorldCoordinates(ChunkData chunkData, int x, int y, int z)
    {
        ...
        chunkDataDictionary.TryGetValue(position, out containerChunk);
        ...
        Vector3Int blockInChunkCoordinates = Chunk.GetBlockInChunkCoordinate(containerChunk, new Vector3Int(x, y, z));
